...
import svgPaths from "./svg-fgp2xx7iny";
...
import { img29 } from "./svg-8zc3d";
type IPhone1617Pro11HelperProps = {
  additionalClassNames?: string;
};

function IPhone1617Pro11Helper({ children, additionalClassNames = "" }: React.PropsWithChildren<IPhone1617Pro11HelperProps>) {
  return (
...
export default function IPhone1617Pro() {
  return (
    <div className="bg-black border-4 border-solid border-white overflow-clip relative rounded-[25px] size-full" data-name="iPhone 16 & 17 Pro - 11">
      <div className="absolute contents left-[38px] top-[134px]">
        ...
        <div className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold h-[51px] leading-none left-[201px] not-italic text-[8px] text-center text-white top-[277px] w-[240px]">
          <p className="mb-0">26th Feb 2026 @ 7pm</p>
          <p>&nbsp;</p>
        </div>
      ...
      <IPhone1617Pro11Helper additionalClassNames="left-[calc(50%+1345.16px)] top-[calc(50%-194.78px)]">
        <p className="leading-[86.917px]">A colour</p>
      </IPhone1617Pro11Helper>
      <IPhone1617Pro11Helper additionalClassNames="left-[calc(50%+1417.16px)] top-[calc(50%+395.22px)]">
