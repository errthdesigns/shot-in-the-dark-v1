...
import svgPaths from "./svg-dx5qt63hhr";
...
import { img29 } from "./svg-5zdht";
type IPhone1617Pro7HelperProps = {
  additionalClassNames?: string;
};

function IPhone1617Pro7Helper({ children, additionalClassNames = "" }: React.PropsWithChildren<IPhone1617Pro7HelperProps>) {
  return (
...
export default function IPhone1617Pro() {
  return (
    <div className="bg-black border-4 border-solid border-white overflow-clip relative rounded-[25px] size-full" data-name="iPhone 16 & 17 Pro - 7">
      <IPhone1617Pro7Helper additionalClassNames="left-[calc(50%+1345.16px)] top-[calc(50%-194.78px)]">
        <p className="leading-[86.917px]">A colour</p>
      </IPhone1617Pro7Helper>
      <IPhone1617Pro7Helper additionalClassNames="left-[calc(50%+1417.16px)] top-[calc(50%+395.22px)]">
        <p className="leading-[60px]">A photo of your dog?</p>
      </IPhone1617Pro7Helper>
      ...
      <div className="absolute contents left-[38px] top-[134px]">
        <div className="absolute contents left-[42px] top-[138px]" data-name="Mask group">
          <div className="absolute contents left-[-98px] top-[117.21px]" data-name="Mask group">
