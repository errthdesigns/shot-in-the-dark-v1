...
import svgPaths from "./svg-sz2dfe1z0q";
...
import imgPicture14 from "figma:asset/f6c6e9c6f524954535fb49da09dd08b3bfe53f32.png";
import { img29 } from "./svg-ehavl";
type WrapperProps = {
...
export default function MacBookPro() {
  return (
    <div className="bg-white relative size-full" data-name="MacBook Pro 16' - 20">
      ...
      <div className="-translate-y-1/2 absolute bg-black border-4 border-solid border-white h-[874px] left-[1062px] overflow-clip rounded-[25px] top-[calc(50%-417px)] w-[402px]" data-name="iPhone 16 & 17 Pro - 4">
      ...
      <div className="-translate-y-1/2 absolute bg-black border-4 border-solid border-white h-[874px] left-[1526px] overflow-clip rounded-[25px] top-[calc(50%-417px)] w-[402px]" data-name="iPhone 16 & 17 Pro - 7">
        <Text text="A colour" />
        <Text1 text="A photo of your dog?" />
        <div className="absolute contents left-[103px] top-[763px]">
          <div className="absolute bg-[#383838] content-stretch flex items-center left-[168px] px-[22px] py-[16.077px] rounded-[33px] size-[66px] top-[767px]">
        ...
        <div className="absolute contents left-[38px] top-[134px]">
          ...
          <div className="-translate-x-1/2 absolute capitalize font-['Spectral:Medium_Italic',sans-serif] italic leading-[1.35] left-[201.22px] text-[16.786px] text-center text-white top-[226px] tracking-[3.3572px] w-[284.433px]">
            <p className="mb-0">1920’s Great Gatsby</p>
            <p>{`Murder Mystery `}</p>
          </div>
          <div className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold h-[51px] leading-none left-[201px] not-italic text-[8px] text-center text-white top-[283px] w-[240px] whitespace-pre-wrap">
            <p className="mb-0">{`26th Feb 2026 `}</p>
            <p>7pm</p>
          </div>
          <div className="absolute h-[41px] left-[75px] rounded-[20px] top-[530px] w-[252px]" data-name="Button">
            <div className="absolute bg-white inset-0 rounded-[20px]" />
            <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold inset-[34.15%_37.74%_31.71%_37.74%] leading-[1.141] not-italic text-[#313131] text-[12px] text-center tracking-[1.8px] whitespace-nowrap">I WILL BE ATTENDING</p>
          </div>
          <div className="absolute h-[41px] left-[75px] rounded-[20px] top-[581px] w-[252px]" data-name="Button">
            ...
            <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold inset-[34.15%_37.74%_31.71%_37.74%] leading-[1.141] not-italic text-[12px] text-center text-white tracking-[1.8px] whitespace-nowrap">I HAVE TO DECLINE</p>
          </div>
        </div>
      </div>
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[73.92%_22.82%_19.47%_70.16%] leading-none not-italic text-[9px] text-center text-white whitespace-pre-wrap">
        ...
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">{`You're in for a night of secrets, suspicion, and Don Julio. Someone at your table has blood on their hands. `}</p>
        <p className="mb-0">&nbsp;</p>
      ...
      <p className="absolute font-['Jaguar_Exuberant:Regular',sans-serif] inset-[77.97%_5.9%_20.8%_83.99%] leading-[1.35] not-italic text-[14px] text-black text-center">18th July 2025, 8pm</p>
      <p className="absolute font-['Jaguar_Exuberant:Bold',sans-serif] inset-[74.39%_5.9%_23.41%_83.99%] leading-[1.45] not-italic text-[20px] text-black text-center tracking-[1px] uppercase">ANNUAL TRAILBLAZER CELEBRATION</p>
      <div className="absolute bg-black h-[41px] left-[2378px] top-[1766px] w-[318px]" data-name="Button">
        <div className="absolute bg-[rgba(255,255,255,0.85)] inset-0" />
        <p className="absolute font-['JLR_Emeric:SemiBold',sans-serif] inset-[34.15%_37.74%_31.71%_37.74%] leading-[1.141] not-italic text-[#313131] text-[12px] text-center tracking-[1.8px] whitespace-nowrap">I WILL BE ATTENDING</p>
      </div>
      <div className="absolute bg-black h-[41px] left-[2378px] top-[1833px] w-[318px]" data-name="Button">
        <div className="absolute border border-[rgba(255,255,255,0.85)] border-solid inset-0" />
        <p className="absolute font-['JLR_Emeric:SemiBold',sans-serif] inset-[34.15%_27.99%_31.71%_28.3%] leading-[1.141] not-italic text-[12px] text-[rgba(255,255,255,0.85)] text-center tracking-[1.8px] whitespace-nowrap">I HAVE TO DECLINE</p>
      </div>
      <div className="absolute contents left-[2033px] top-[1387px]">
        <div className="absolute bg-[rgba(0,0,0,0.5)] border-[0.614px] border-solid border-white h-[27px] left-[2033px] rounded-[57.682px] top-[1387px] w-[132px]" />
        <p className="-translate-x-full absolute font-['Inter:Regular',sans-serif] font-normal h-[12px] leading-[1.495] left-[calc(50%+716.5px)] not-italic text-[8px] text-right text-white top-[1395px] w-[76px]">Birch Hotel, London</p>
        <div className="absolute inset-[71.36%_27.87%_27.87%_71.81%]" data-name="Vector">
      ...
      <div className="absolute h-[241px] left-[2378px] rounded-[10px] top-[1183px] w-[318px]" data-name="Picture 1 4">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgPicture14} />
      </div>
      ...
      <div className="-translate-y-1/2 absolute bg-black border-4 border-solid border-white h-[874px] left-[622px] overflow-clip rounded-[25px] top-[calc(50%-417px)] w-[402px]" data-name="iPhone 16 & 17 Pro - 6">
        <Text text="A colour" />
        <Text1 text="A photo of your dog?" />
        <div className="absolute contents left-[103px] top-[763px]">
          <div className="absolute bg-[#383838] content-stretch flex items-center left-[168px] px-[22px] py-[16.077px] rounded-[33px] size-[66px] top-[767px]">
      ...
      <div className="-translate-y-1/2 absolute bg-black border-4 border-solid border-white h-[874px] left-[1999px] overflow-clip rounded-[25px] top-[calc(50%-417px)] w-[402px]" data-name="iPhone 16 & 17 Pro - 1">
        <Text text="A colour" />
        <Text1 text="A photo of your dog?" />
