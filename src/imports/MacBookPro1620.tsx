...
import svgPaths from "./svg-yhri6j5gct";
...
export default function MacBookPro() {
  return (
    <div className="bg-white relative size-full" data-name="MacBook Pro 16' - 20">
      ...
      <div className="absolute bg-black h-[1117px] left-0 top-0 w-[2167px]" />
      <div className="-translate-y-1/2 absolute bg-black border-4 border-solid border-white h-[874px] left-[1110px] overflow-clip rounded-[25px] top-[calc(50%+0.5px)] w-[402px]" data-name="iPhone 16 & 17 Pro - 4">
      ...
      <div className="-translate-y-1/2 absolute bg-black border-4 border-solid border-white h-[874px] left-[133px] overflow-clip rounded-[25px] top-[calc(50%+0.5px)] w-[402px]" data-name="iPhone 16 & 17 Pro - 5">
        <Text text="A colour" />
        <Text1 text="A photo of your dog?" />
        <div className="absolute contents left-[103px] top-[763px]">
          <div className="absolute bg-[#383838] content-stretch flex items-center left-[168px] px-[22px] py-[16.077px] rounded-[33px] size-[66px] top-[767px]">
      ...
      <div className="-translate-y-1/2 absolute bg-black border-4 border-solid border-white h-[874px] left-[622px] overflow-clip rounded-[25px] top-[calc(50%+0.5px)] w-[402px]" data-name="iPhone 16 & 17 Pro - 6">
        <Text text="A colour" />
        <Text1 text="A photo of your dog?" />
        <div className="absolute contents left-[103px] top-[763px]">
          <div className="absolute bg-[#383838] content-stretch flex items-center left-[168px] px-[22px] py-[16.077px] rounded-[33px] size-[66px] top-[767px]">
      ...
      <div className="-translate-y-1/2 absolute bg-black border-4 border-solid border-white h-[874px] left-[1632px] overflow-clip rounded-[25px] top-[calc(50%+0.5px)] w-[402px]" data-name="iPhone 16 & 17 Pro - 1">
        <Text text="A colour" />
        <Text1 text="A photo of your dog?" />
